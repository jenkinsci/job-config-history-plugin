...
public class JobConfigHistoryRootActionIT extends AbstractHudsonTestCaseDeletingInstanceDir {
    ...
    public void testFilterWithData() {
        ...
        try {
            ...
            assertFalse("Verify that only \'Deleted\' entries are listed.", page.contains("Created</td>") || page.contains("Changed</td>"));
        } catch (Exception ex) {
